...
<div class="columna"><div class="column-header"> Distribución de Casos </div>
...
</div><div class="columna"><div class="column-header"> Cadenas de Transmisión </div>
...
</div><div class="columna"><div class="column-header"> Mapa de Calor </div>

::: grid-card

```{r heatmap_hermosillo,echo=FALSE}
library(sf)
library(mapgl)
load("/Users/fdzul/Documents/geocoding_mx_2026_dengue/4.RData/dengue_mx_2026.RData")
...
```{r distribucion_hermosillo3,echo=FALSE}
library(mapgl)
library(fishualize)
library(sf)
load("/Users/fdzul/Documents/geocoding_mx_2026_dengue/4.RData/dengue_mx_2026.RData")
...
```{r chains_hermosillo3,echo=FALSE}
library(mapgl)
library(fishualize)
library(sf)
...
```{r heatmap_hermosillo3,echo=FALSE}
library(sf)
library(mapgl)
load("/Users/fdzul/Documents/geocoding_mx_2026_dengue/4.RData/dengue_mx_2026.RData")
source("~/Library/CloudStorage/Dropbox/r_developments/r_dashboards/netlify/1.2.persisten_dengue_transmission_2026/persistent_dengue_transmission_10_durango/mp_heatmap.R")
...
# [**Cadenas de Transmisión2**]{style="font-size:8pt"}
